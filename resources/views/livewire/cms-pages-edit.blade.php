                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            ...
                                            <span class="ml-3 text-xs font-medium {{ ($block['is_active'] ?? true) ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                                                {{ ($block['is_active'] ?? true) ? '✓ Active' : '✗ Inactive' }}
                                            </span>
                                        </label>
                                    </div>
                                </div>
